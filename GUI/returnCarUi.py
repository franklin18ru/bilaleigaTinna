...
class ReturnCarUi(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def getCarByLicensePlate(self,controller):
            ...
            self.renterName = tk.Label(renterFrame, text="Nafn: "+ str(returnCar.carOrder[0][1]), bg="#5A6D7C", fg="white")
            self.renterSSN = tk.Label(renterFrame, text="Kennitala: "+ str(returnCar.carOrder[0][0]), bg="#5A6D7C", fg="white")
            ...
            self.carName = tk.Label(carFrame, text="Tegund Bíls: "+ str(returnCar.car[1]), bg="#5A6D7C", fg="white")
            self.carLicensePlate=tk.Label(carFrame, text="Bílnúmer: "+ str(returnCar.car[0]), bg="#5A6D7C", fg="white")
