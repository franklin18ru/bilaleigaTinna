...
costumer_car = Button(root,   text="2. Leita eftir bíl", bg="#424242", fg="white", width=22, height=3)
costumer_allorders = Button(root,       text="3. Allar pantanir", bg="#424242", fg="white", width=22, height=3)
...
costumer_allorders.config( font=("Courier",16))
...
costumer_car.grid(row=5, column=3)
costumer_allorders.grid(row=5, column=4)
