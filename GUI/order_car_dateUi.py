...
start = Label(root, text="Til: ",bg="#5A6D7C",fg="white")
end = Label(root, text="Frá: ",bg="#5A6D7C",fg="white")

#Create entry fields
startInput = Entry(root, width=20, font=("Courier", 20))
endInput = Entry(root, width=20, font=("Courier", 20))
